...
while index < len(mid_list):
    ...
    lineup=source.find_all("ul",class_="lineup")
    
    
    #print(source.body.div.contents[2].contents[3].contents[0].contents[2])
    #print(source.body)
    #print(source.body.contents[0])
    #print(source.body.contents[0].contents[2])
    #print(source.body.contents[0].contents[2].contents[3])
    #print(source.body.contents[0].contents[2].contents[3].contents[0])
    #print(source.body.contents[0].contents[2].contents[3].contents[0].contents[2])
    #print(source.body.div.div.contents[2])
    #print(type(source.body.div.contents[2].contents[3]))
    #print(type(source.body.div.contents[2].contents[3].contents[0]))
    #print(type(source.body.div.contents[2].contents[3].contents[0].contents[2]))
    
    i=0
    lineup=source.find_all("ul",class_="lineup")
    for art in lineup[0].contents:
        print("-------------------------",i,"-----------------------------------")
        print(type(art))
        print(art)
        i+=1
